...
export const translations = {
  kz: {
    ...
    mission: {
      ...
      patriotism: {
        title: "Патриотизм",
        description: "Отанды құрметтеу – біздің басты принцип. Қызметтің мәнін жүрегімізбен сезінеміз."
      }
    },
    program: {
